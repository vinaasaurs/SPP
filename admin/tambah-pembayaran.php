...
<input  name= "id_spp" value = "<?= $data['id_spp']?>" type="hidden" class="form-control" required>
    ...
    <div class="form-group mb-2">
        ...
        <input disabled value = "<?= $data['nama_siswa']?>" type="text"   class="form-control" required>
    </div>
    <div class="form-group mb-2">
    ...
    <div class="form-group mb-2">
        ...
        <div class="form-group mb-2">
        <label>Jumlah Bayar (Jumlah yg harus dibayar <b><?= number_format($kurang,2,',','.') ?></b>)</label>
        <input type="number" name="jumlah_bayar" max= <?= $kurang; ?> class="form-control" required>
    </div>
    </div>
